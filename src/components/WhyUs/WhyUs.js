                    ...
                    <div className="row row-cols-1 row-cols-md-2 g-4">
                        ...
                        <div className="col">
                            <div className="card h-100 bg-color shadow">
                                <div className="my-5 d-flex flex-column align-items-center">
                                    <div className="bg-danger icn-bg d-flex align-items-center justify-content-center mb-3">
                                        <i className="fas fa-tv fs-3 text-white"></i>
                                    </div>
                        ...
                        <div className="col">
                            <div className="card h-100 bg-color shadow">
                                <div className="my-5 d-flex flex-column align-items-center">
                                    <div className="bg-danger icn-bg d-flex align-items-center justify-content-center mb-3">
                                        <i className="fas fa-certificate fs-3 text-white"></i>
                                    </div>
                    ...
                    <div className="accordion" id="accordionExample">
                        ...
                        <div className="accordion-item">
                            <h2 className="accordion-header" id="headingThree">
                                <button className="accordion-button collapsed shadow-none" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                    Lifetime Membership
                                </button>
                            </h2>
