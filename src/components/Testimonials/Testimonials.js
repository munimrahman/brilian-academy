                ...
                <div className="carousel-inner">
                    <div className="carousel-item active" data-bs-interval="2000">
                        ...
                        <div className="d-flex justify-content-center align-items-center">
                            ...
                            <img src={personOne} className="d-block border border-3 border-danger carousel-img mx-3" alt="..." />
                            <div className="hr-line border border-danger w-25"></div>
                        </div>
                    ...
                    <div className="carousel-item" data-bs-interval="2000">
                        ...
                        <div className="d-flex justify-content-center align-items-center">
                            <div className="hr-line border border-danger w-25"></div>
                            <img src={personTwo} className="d-block border border-3 border-danger carousel-img mx-3" alt="..." />
                            <div className="hr-line border border-danger w-25"></div>
                        </div>
                    ...
                    <div className="carousel-item" data-bs-interval="2000">
                        ...
                        <div className="d-flex justify-content-center align-items-center">
                            <div className="hr-line border border-danger w-25"></div>
                            <img src={personThree} className="d-block border border-3 border-danger carousel-img mx-3" alt="..." />
                            <div className="hr-line border border-danger w-25"></div>
                        </div>
